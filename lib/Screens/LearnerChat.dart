...
import 'package:learner_prokit/model/LearnerChatModel.dart';
import 'package:learner_prokit/model/LearnerPepoleModel.dart';
...
class _LearnerChatState extends State<LearnerChat> {
  ...
  void fetchChatData() async {
    ...
    final results = await connection.query('SELECT * FROM learnerchatmodel');
    List<LearnerChatModel> chatData = results.map((row) {
  ...
  void fetchPeopleData() async {
    ...
    final results = await connection.query('SELECT * FROM learnerpeoplemodel');
    List<LearnerPeopleModel> peopleData = results.map((row) {
